...
def filter_visible_windows(wnds: typing.Iterable[gw.Window]) -> typing.List[gw.Window]:
    rwnds = []
    for wnd in wnds:
...
def filter_titled_windows(wnds: typing.Iterable[gw.Window]) -> typing.List[gw.Window]:
    """
